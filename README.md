...
- Change the <code><h1></code> tag text to “Hello everyone, I am learning React at ALX!”.
- Add a new paragraph (<code><p></code>) tag with the custom message, **"I am learning about JSX!"**.
...
- Include the <code><WelcomeMessage /></code> component inside the return statement of the App function.
...
- In the App component’s return statement, include these components in the following order: <code><Header />, <MainContent />, and <Footer />.</code>
- Run the Application:
...
- Create UserProfile Component:
  ...
  - The component should display a user’s name, age, and a short bio. Structure it to include these in JSX elements like <code><h2></code> for the name, <code><p></code> for age, and another <code><p></code> for the bio.
...
- Use UserProfile in App.jsx:
  ...
  - Use the component with props. For example: <code><UserProfile name="Alice" age="25" bio="Loves hiking and photography" /></code>
